	...
	class CCuenta extends CConexion{
...
/*
			$data = parent::conn->query("select * from cuenta where nombre = '$nombre' and pin='$pin'")->fetchAll();	
*/			
		...
		public function Movimientos($idcuenta){
			...
			$this->ObtenerDatosCuenta($_POST["idcuenta"]);

			// obtenemos todos los movimentos de la cuenta
			...
			// vamos a crear un array de objetos de 
			// la clase movimientos
			$movimientos = array();
