		...
		$.ajax({
			...
			success: function(data){
				...
				$.each(partidos, function( key, value ) {
					...
					fila+="	<td width='46px'>"+value.importe+"</td>";				
					fila+="	<td width='179px' style='text-align:left'>"+value.nombre+"</td>";
					fila+=" <td width='20px'>"+value.estado;
			 		fila+=" <img style='cursor:pointer' onclick='confirmarEliminar("+value.idApuesta+")' src='iconos/delete.png' width='15'/></td>";
					fila+="</tr>"; 
