<?php
	...
	class CUsuario extends CBBDD{
		...
		private $WEB_ROOT="http://localhost:8080/php/asesorcompras/vistas/usuarios/confirmar.php";
		...
		private function enviarMail2($to, $subject, $msg){
			$enviado = false;
			try {
		...
		public function Registrar($email, $nombre, $password) {
			try {
				...
				// compose message
				$message = "<p><h1 style='color:#3498db;'>Hola $nombre,</h1> Te informamos que hemos procedido a registrar tu usuario en nuestra aplicación. 
					</p>
					<p>
					<El token a confirmar es $token
					</p>
					<p>
					Para finalizar el registro es necesario confirmar el token. Por favor, pulse el siguiente link:</br></br> $link
					</p>
