...
<div id="CatologoDialog" class="oculta" title="Listado de Categorías">
	...
	<div id="divDatos" style="width:652px;height:380px;overflow-y:auto;">
		<table id="tblDatos" width="620px">		
			<tr>
				<td width='224px' valign='center'>Deporte</td>
				<td width='296px' style='text-align:center'><img src='../../images/Categories/deporte.jpg' width='60px' height='60px' /></td>
				<td width='103px' style='text-align:center'>

					<img style="cursor:pointer" title="Borrado" src="../../iconos/delete.png" width="20"/>

					<img style="cursor:pointer" title="Edición"src="../../iconos/edit.png" width="20" style="margin-left:20px"/>
				</td>
			</tr>
			<tr>
				<td width='224px' valign='center'>Calzado</td>
				<td width='296px' style='text-align:center'><img src='../../images/Categories/Calzado.jpg' width='60px' height='60px' /></td>
				<td width='103px' style='text-align:center'>

					<img style="cursor:pointer" src="../../iconos/delete.png" width="20"/>

					<img style="cursor:pointer" src="../../iconos/edit.png" width="20" style="margin-left:20px"/>
				</td>
			</tr>
					<tr>
				<td width='224px' valign='center'>Moda</td>
				<td width='296px' style='text-align:center'><img src='../../images/Categories/moda.jpg' width='60px' height='60px' /></td>
				<td width='103px' style='text-align:center'>
		...
		$.ajax({
			...
			success: function(data){
				...
				$.each(categorias, function( key, value ) {
					...
					fila+="	<td width='103px' style='text-align:center'><img style='cursor:pointer' onclick='confirmarEliminar("+value.idcategoria+")' src='../../iconos/delete.png' width='20px' title='Borrar'/><img style='cursor:pointer;margin-left:20px' onclick='editar	("+value.idcategoria+")' src='../../iconos/edit.png' width='20px' title='Editar'/>					</td>";
					fila+="</tr>"; 
